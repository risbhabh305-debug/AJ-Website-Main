...
const Hero = () => (
  <section className="relative h-[100svh] min-h-[32rem] overflow-hidden bg-black sm:min-h-0">
    ...
    <div className="absolute bottom-5 left-0 z-10 -translate-x-[10%] md:bottom-10 md:left-10 md:translate-x-0">
      <div className="pointer-events-none absolute -inset-10 rounded-full bg-black/40 blur-3xl" aria-hidden="true" />
      <img src={mobileLogo} alt="Ankush Jewellers" className="relative w-[23rem] brightness-0 invert drop-shadow-[0_6px_18px_rgba(0,0,0,0.55)] md:w-[25rem]" />
      <p className="relative mt-1 -translate-y-8 w-[calc(100vw-1rem)] max-w-[23rem] text-center text-[11.5px] font-semibold uppercase tracking-[0.08em] text-gold">B2B Diamond Jewellery Manufacturer</p>
    </div>
  </section>
);
